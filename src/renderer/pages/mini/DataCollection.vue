...
export default {
  ...
  methods: {
    async getValueOfMbdm(ryid, fileName, mbdm, extField) {
      let value = "";
      switch (mbdm) {
        case "150001": //"mz_tax_records_source":
          {
          ...
          break;
        case "220001": //"mz_phone_call_info":
          {
          ...
          break;
        case "61000021": //"mz_account_info": 平台导出账户信息
          {
            if (extField.toLowerCase() === "ryid") {
              value = ryid;
            }
          ...
          break;
        case "61000020": //"mz_person": 平台导出人员信息
          {
            if (extField.toLowerCase() === "ryid") {
              value = ryid;
          ...
          break;
        case "130002": //"mz_bank_records_source": // 交易明细
          {
        ...
        case "145001": //"mz_im_msg":  微信通讯记录
          ...
          break;
        case "110002": //"mz_bank_records_source": // 通用模版
          {
          ...
          break;
        case "160001": //"mz_account_info": 开户信息
          {
            if (extField.toLowerCase() === "ryid") {
              // 交易记录
              value = ryid;
          ...
          break;
        case "130001": //mz_account_info 账户信息列表
          {
            if (extField.toLowerCase() === "ryid") {
              // 交易记录
              value = ryid;
    ...
    async copyTempDataToRealTable(args) {
      ...
      try {
        return await new Promise(async (resolve, rejcect) => {
          ...
          // 如果为mz_bank_records 那么备份
          let streamFrom2 = null;
          if (targetTableName === "mz_bank_records") {
            // 创建copyFrom流
