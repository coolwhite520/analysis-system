<template>
  <el-dialog v-dialogDrag :close-on-click-modal="false" class="standard-data-dialog" :append-to-body="true"
    :visible="showDataVisibilityDialogVisible" width="35%" @close="handleClose" :modal="true">
    ...
    <el-tabs v-model="activeName" type="card">
      <el-tab-pane label="推荐设定" name="first" style="text-align: center">
        <el-row>
          <el-col :span="8">
            <div class="myRadioDataType" @click="
              handleClickDataType('1', '/static/images/icons/银行卡.png')
            " :style="{
  backgroundColor:
    selectDataTypeValue === '1' ? '#f0fefe' : 'white',
}">
              <img src="/static/images/icons/银行卡.png" width="40" height="40" style="vertical-align: middle" />
              <div>账户</div>
              <div class="iconfont">
          ...
          <el-col :span="8">
            <div class="myRadioDataType" @click="handleClickDataType('3', '/static/images/icons/主体.png')" :style="{
              backgroundColor:
                selectDataTypeValue === '3' ? '#f0fefe' : 'white',
            }">
              <img src="/static/images/icons/主体.png" width="40" height="40" style="vertical-align: middle" />
              <div>主体名称</div>
              <div class="iconfont">
          ...
          <el-col :span="8">
            <div class="myRadioDataType" @click="handleClickDataType('2', '/static/images/icons/证件.png')" :style="{
              backgroundColor:
                selectDataTypeValue === '2' ? '#f0fefe' : 'white',
            }">
              <img src="/static/images/icons/证件.png" width="40" height="40" style="vertical-align: middle" />
              <div>证件号码</div>
              <div class="iconfont">
        ...
        <div class="myRadio" @click="handleClickSelect('1')" type="text" :style="{
          ...
          <span>&nbsp;&nbsp;汇总&nbsp;&nbsp;</span>
          <img :src="imgSrc" width="40" height="40" style="vertical-align: middle" />
          <img src="/static/images/row/row2.png" width="160" height="40" style="vertical-align: middle" />
          <img :src="imgSrc" width="40" height="40" style="vertical-align: middle" />
        </div>
        <div class="myRadio" @click="handleClickSelect('2')" type="text" :style="{
          ...
          <span>&nbsp;&nbsp;差额&nbsp;&nbsp;</span>
          <img :src="imgSrc" width="40" height="40" style="vertical-align: middle" />
          <img src="/static/images/row/row1.png" width="160" height="28" style="vertical-align: middle" />
          <img :src="imgSrc" width="40" height="40" style="vertical-align: middle" />
        </div>
        ...
        <el-row style="margin-top: 20px">
          ...
          <el-col :span="16">
            <el-input size="small" v-model="minJybs"></el-input></el-col>
          <el-col :span="2">&nbsp;</el-col>
        </el-row>
        <el-row style="margin-top: 10px; text-align: center">
          <el-col :span="6">最小交易金额:</el-col>
          <el-col :span="16">
            <el-input size="small" v-model="minJyje"></el-input></el-col>
          <el-col :span="2">&nbsp;</el-col>
        </el-row>
        <el-row style="margin-top: 30px">
          <el-button type="primary" style="width: 50%" @click="handleClickSubmit" :loading="loading">确定</el-button>
        </el-row>
      </el-tab-pane>
